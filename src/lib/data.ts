...
export const LIFE_MOMENTS: LifeMoment[] = [
  {
    key: "outgrown",
    icon: "swing",
    label: "Kid stuff outgrown",
    description: "Crib, bunk bed, swing set, toys",
    service: "bulk",
  ...
  },
  {
    key: "new-furniture",
    icon: "couch",
    label: "Old couch / furniture",
    description: "Out before the new one arrives",
    service: "bulk",
    items: { couch: 1 },
  },
  {
    key: "yard-day",
    icon: "leaf",
    label: "Yard waste bags",
    description: "Leaves, clippings, garden cleanup",
    service: "yard",
    bags: 5,
  },
  {
  ...
  },
  {
    ...
    description: "Whatever's piled up",
    service: "bulk",
    items: { other: 1 },
  },
];
...
export const COMPARISON: ComparisonRow[] = [
  ...
  },
  {
    ...
    nitti: "None",
    typical: "$10–20 added per invoice",
  },
  {
    feature: "Price after year one",
    nitti: "Same flat, published price",
    typical: "Intro rate, then increases",
  },
  {
